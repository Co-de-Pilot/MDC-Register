...
public class FullOrPeriodReportAFCL {
	...
	private List<AnnualFlightClearance> listOfPrintedAFCL;

	public FullOrPeriodReportAFCL(String title, LocalDate dateFromPeriodReport, LocalDate dateUntilPeriodReport,
			List<AnnualFlightClearance> listOfPrintedAFCL) {
		this.title = title;
	...
	public void createPdf(String dest) throws IOException {
		...
		Text titleOfPDF = new Text("\n" + title + "\n" + "az éves katonai diplomáciai engedélyekről" + "\n");
		...
		float[] tableHeaderColumnWidth = { 90f, 110f, 60f, 60f, 50f, 50f, 60f, 25f, 25f, 25f, 220f };
		...
		String[] fullReportColumnNames = { "KKM\nnyt. szám", "Regisztráló\nország", "Érvényesség\nkezdődátuma",
				"Érvényesség\nzáródátuma", "Repülőgép\ntípusa", "Repülőgép\nlajstromjele", "Repülőgép\nhívójele",
				"Enge-\ndélyezett", "Aktív", "Módo-\nsított", "Megjegyzés" };
		...
		for (AnnualFlightClearance clearance : listOfPrintedAFCL) {
