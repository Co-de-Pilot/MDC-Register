...
public class DailyReportAFCL {
	...
	public DailyReportAFCL(String title, LocalDate dateOfReport, List<AnnualFlightClearance> listOfPrintedAFCL) {
		this.title = title;
	...
	public void createPdf(String dest) throws IOException {
		...
		Text titleOfPDF = new Text("\n" + title + "\n" + "az érvényes éves katonai diplomáciai engedélyekről"
		...
		float[] tableHeaderColumnWidth = { 90f, 110f, 60f, 60f, 50f, 50f, 60f, 20f };
