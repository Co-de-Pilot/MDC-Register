...
public class DesignComboBox<E> extends JComboBox<E> {
    ...
    public DesignComboBox(String[] countries, String name, int x, int y, int width, int height) {
    	setModel((ComboBoxModel<E>) new DefaultComboBoxModel<String>((String[]) countries));
    	setOpaque(false);
