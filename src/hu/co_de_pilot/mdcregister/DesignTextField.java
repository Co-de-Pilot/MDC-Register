...
public class DesignTextField extends JTextField {
    ...
    private final Insets shadowSize = new Insets(5, 8, 15, 11);

    public DesignTextField(String name, String defaultText, int x, int y, int width, int height) {
        setUI(new TextUI());
        setOpaque(false);
	...
	public String toString() {
		...
		builder.append("DesignTextField [");
		builder.append("Name: ");
